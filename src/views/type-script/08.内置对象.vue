...
const builtIn1 = `let b: Boolean = new Boolean(1)
console.log(b)
let n: Number = new Number(true)
console.log(n)
let s: String = new String('xxxxxxxx')
console.log(s)
let d: Date = new Date()
console.log(d)
let r: RegExp = /^1/
...
const builtIn2 = `let body: HTMLElement = document.body;
...
const builtIn3 = `function promise():Promise<number>{
